...
PID_typedef PID2;
PID_typedef PID3;
motor_measure_t motor_chassis[3]={0};//�����Ϣ
...
double chassis_motor_1_pid() //�ײ�����
{
	double vx = DBUS_decode_val.rocker[2]*2.0;
	double vy = DBUS_decode_val.rocker[3]*2.0;
	double vc = DBUS_decode_val.rocker[0]*2.0;
	
	double target_val = (-vx+vc)*6.0;
...
double chassis_motor_2_pid()  //�������
{
	...
	double target_val = (vx+vc+vy)*6.0;
